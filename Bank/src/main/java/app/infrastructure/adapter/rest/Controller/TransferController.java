...
import app.domain.ports.in.ApproveTransferUseCase;
import app.domain.ports.in.CreateTransferUseCase;
import app.domain.ports.in.FindTransferUseCase;
import app.domain.ports.in.RejectTransferUseCase;
import app.infrastructure.adapter.rest.dto.transfer.ApproveTransferRequest;
import app.infrastructure.adapter.rest.dto.transfer.CreateTransferRequest;
import app.infrastructure.adapter.rest.dto.transfer.RejectTransferRequest;
import app.infrastructure.adapter.rest.dto.transfer.TransferResponse;
import app.infrastructure.adapter.rest.mapper.TransferDtoMapper;
