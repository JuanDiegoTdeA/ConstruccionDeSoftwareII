package app.infrastructure.adapter.rest.exception;

import app.domain.Exceptions.BusinessException;
import app.domain.Exceptions.InsufficientFundsException;
import app.domain.Exceptions.InvalidStateTransitionException;
import app.domain.Exceptions.ResourceNotFoundException;
import app.domain.Exceptions.UnauthorizedOperationException;
import app.infrastructure.adapter.rest.dto.common.ErrorResponse;
