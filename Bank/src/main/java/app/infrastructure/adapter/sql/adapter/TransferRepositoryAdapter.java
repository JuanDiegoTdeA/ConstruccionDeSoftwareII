...
import app.infrastructure.adapter.sql.entity.TransferEntity;
import app.infrastructure.adapter.sql.entity.UserEntity;
import app.infrastructure.adapter.sql.mapper.TransferMapper;
import app.infrastructure.adapter.sql.repository.BankAccountJpaRepository;
import app.infrastructure.adapter.sql.repository.TransferJpaRepository;
