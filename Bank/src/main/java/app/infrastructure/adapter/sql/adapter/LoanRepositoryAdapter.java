...
import app.infrastructure.adapter.sql.mapper.LoanMapper;
import app.infrastructure.adapter.sql.repository.BankAccountJpaRepository;
import app.infrastructure.adapter.sql.repository.ClientJpaRepository;
import app.infrastructure.adapter.sql.repository.LoanJpaRepository;
