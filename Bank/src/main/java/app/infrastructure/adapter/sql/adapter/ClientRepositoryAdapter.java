...
import app.infrastructure.adapter.sql.entity.ClientEntity;
import app.infrastructure.adapter.sql.entity.IndividualClientEntity;
import app.infrastructure.adapter.sql.mapper.ClientMapper;
import app.infrastructure.adapter.sql.repository.BusinessClientJpaRepository;
import app.infrastructure.adapter.sql.repository.ClientJpaRepository;
import app.infrastructure.adapter.sql.repository.IndividualClientJpaRepository;
